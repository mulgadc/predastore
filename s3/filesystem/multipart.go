...
func (b *Backend) CompleteMultipartUpload(bucket string, file string, uploadId string, c *fiber.Ctx) error {
	// TODO: Move validation to common function
	bucket_config, err := b.Config.BucketConfig(bucket)
	...
	completeMultipartUploadResult := s3.CompleteMultipartUploadResult{}
...
func (b *Backend) CreateMultipartUpload(bucket string, file string, c *fiber.Ctx) error {
	bucket_config, err := b.Config.BucketConfig(bucket)
	...
	Resp_InitiateMultipartUpload := s3.InitiateMultipartUploadResult{}
...
// PutObjectPart handles uploading a single part of a multipart upload
func (b *Backend) PutObjectPart(bucket string, file string, partNumber int, uploadId string, c *fiber.Ctx) error {
	bucket_config, err := b.Config.BucketConfig(bucket)
