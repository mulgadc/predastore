...
func TestDeleteObject(t *testing.T) {
	...
	// Make a PUT request
	req := httptest.NewRequest(http.MethodPut, "/local/test_delete.txt", bytes.NewReader(testContent))
	...
	req = httptest.NewRequest(http.MethodDelete, "/local/test_delete.txt", nil)
...
func TestDeleteObjectRemovePath(t *testing.T) {
	...
	// Make a PUT request
	req := httptest.NewRequest(http.MethodPut, "/local/folder1/folder2/data/test_delete.txt", bytes.NewReader(testContent))
	...
	// Make a PUT request
	req = httptest.NewRequest(http.MethodPut, "/local/folder1/sample.txt", bytes.NewReader(testContent))
	...
	req = httptest.NewRequest(http.MethodDelete, "/local/folder1/folder2/data/test_delete.txt", nil)
	...
	req = httptest.NewRequest(http.MethodGet, "/local/folder1/folder2/data/", nil)
	...
	req = httptest.NewRequest(http.MethodGet, "/local?list-type=2&prefix=folder1%2F&delimiter=%2F&encoding-type=url", nil)
