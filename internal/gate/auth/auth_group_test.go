...
// --- fake jetstream.JetStream (embeds the interface; only KeyValue is exercised) ---
...
func (j *fakeJS) KeyValue(_ context.Context, bucket string) (jetstream.KeyValue, error) {
	return nil, j.kvErr
}
