...
func UploadPart(st Store, shards *storage.Client, ring *placement.Ring, cache *BucketCache, cfg Config) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err := statePut(st, model.TableParts, multipartPartKey(uploadID, partNumber), partBuf.Bytes()); err != nil {
		...
		if err := statePut(st, model.TableObjects, partShardKey(uploadID, partNumber), shardBuf.Bytes()); err != nil {
