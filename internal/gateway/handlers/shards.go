...
func putObjectViaQUIC(ctx context.Context, shards *storage.Client, ring *placement.Ring, cfg Config, objectPath string, objectHash [32]byte) (size int64, poolNearFull bool, err error) {
...
func openInput(st Store, ring *placement.Ring, cfg Config, bucket string, object string) (ObjectToShardNodes, int64, error) {
...
func reconstructObject(ctx context.Context, client *storage.Client, objectHash [32]byte, shards ObjectToShardNodes, enc reedsolomon.StreamEncoder, size int64) (*bytes.Buffer, error) {
