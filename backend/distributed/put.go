...
func (backend Backend) PutObjectPart(bucket string, object string, partNumber int, uploadId string, c *fiber.Ctx) error {
	return errors.New("PutObjectPart not yet implemented for distributed backend")
}
