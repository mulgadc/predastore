...
// GetObjectHead handles HEAD requests for objects
func (b *Backend) GetObjectHead(bucket string, file string, c *fiber.Ctx) error {
...
func (b *Backend) GetObject(bucket string, file string, c *fiber.Ctx) error {
	bucket_config, err := b.Config.BucketConfig(bucket)
